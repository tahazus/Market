...
class SocialRight extends HTMLElement {
  connectedCallback() {
    ...
    <div class="hidden xl:flex fixed top-1/3 right-4 z-10 flex-col space-y-1 pointer-events-auto">
      ...
      <a href="https://steamcommunity.com/id/TahazuS" class="bg-red-900 hover:bg-red-800 px-4 py-3 border-2 border-white/50">
        <img src="/Images/steam.png" alt="آیکن استیم" loading="lazy">
      </a>
      <a href="https://x.com/TahaHadian" class="bg-red-900 hover:bg-red-800 px-4 py-3 border-2 border-white/50">
        <img src="/Images/twitter.png" alt="آیکن ایکس (توییتر)" loading="lazy">
      </a>
      <a href="https://discord.gg/a7PrkNjXWk" class="bg-red-900 hover:bg-red-800 px-4 py-3 rounded-b-xl border-2 border-white/50">
        <img src="/Images/discord.png" alt="آیکن دیسکورد" loading="lazy">
      </a>
    </div>
    `;
  }
